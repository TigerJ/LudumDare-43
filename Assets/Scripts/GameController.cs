...
public class GameController : MonoBehaviour {
    ...
    void Start()
    {
        ...
        AddEvent("Have Frogs Will Travel", "Upon over the next hill, the wagon train encounters a man dressed head to toe in black. He draws a frog out of his holster and points it at you. \"This frog says there's not going to be any trouble passing through here\" He proclaims. You can tell the cold look in his eyes he means business. ", 0, 5, 0, 0, 0, 0, 5, event9Option1, event9Option2, event9Option3);
